...
class StylesControllerTest < ActionController::TestCase
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post :create, style: { image: @style.image, mate: @style.mate, string: @style.string, stylecode: @style.stylecode, stylename: @style.stylename, users: @style.users }
    end
  ...
  test "should update style" do
    patch :update, id: @style, style: { image: @style.image, mate: @style.mate, string: @style.string, stylecode: @style.stylecode, stylename: @style.stylename, users: @style.users }
    assert_redirected_to style_path(assigns(:style))
  end
